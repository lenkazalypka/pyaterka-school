...
export function AuthScreen({ mode, initialName, initialEmail, initialPhone, diagnosticSubject, diagnosticSubjectName, diagnosticWeakTopics, diagnosticScore, diagnosticAnswers, selectionSummary }: AuthScreenProps) {
