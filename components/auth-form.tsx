...
export function AuthForm({ mode, initialName = "", initialEmail = "", initialPhone = "", diagnosticSubject, diagnosticAnswers }: AuthFormProps) {
  ...
  return <form action={action} className="mt-8 space-y-4">
    ...
    {mode === "register" && diagnosticAnswers && <input name="diagnosticAnswers" type="hidden" value={diagnosticAnswers} />}
