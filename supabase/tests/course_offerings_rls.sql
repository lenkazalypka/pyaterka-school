...
select test.assert_count('anon does not read subscription offerings','select count(*) from public.subscription_offerings where subscription_id=''70707070-0000-4000-8000-000000000001''',0);
reset role;
