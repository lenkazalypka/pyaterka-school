...
-- Users. Trigger creates profiles and initial roles.
...
-- Parent starts pending for the negative case.
...
-- Group C activates the teacher-positive draft branch.
...
-- Student and all three previously uncovered catalog tables.
...
-- Teacher positive and negative scopes, including draft hierarchy.
...
-- is_local regression: session claim survives into the next statement.
select test.set_user('11111111-1111-4111-8111-111111111111');
